...
IUSE="bzip2 debug doc ffmpeg fftw gdbm glut gnome gtk gtk1 hardened java jpeg kerberos msql mysql odbc opengl oracle pcre sass scanner sdl sqlite svg test tiff truetype vcdiff webp x86-fbsd zlib"
